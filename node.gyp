  ...
  'targets': [
    {
      ...
      'type': 'none',
      'conditions': [
        [ 'OS in "linux freebsd solaris openharmony haiku" and '
          'target_arch=="x64"', {
          'type': 'static_library',
          'sources': [
    ...
    },
    {
      ...
      'conditions': [
        ...
        [ 'node_shared=="true"', {
          ...
          'conditions': [
            ['OS=="linux" or OS=="openharmony" or OS=="haiku"', {
               'ldflags': [
                 '-Wl,-rpath,\\$$ORIGIN/../lib'
               ],
            }],
        ...
        [ 'OS in "linux freebsd openharmony haiku" and '
          'target_arch=="x64"', {
    ...
    }, # node_core_target_name
    {
      ...
      'conditions': [
        ...
        [ 'OS in "linux freebsd mac solaris openharmony haiku" and '
          'target_arch=="x64" and '
          'node_target_type=="executable"', {
    ...
    }, # nop
    {
      ...
      'conditions': [
        ...
        [ 'OS in "linux mac openharmony haiku"', {
